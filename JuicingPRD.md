...
Core Rebrand: Rebranded from JuiceSnap to Juicing.
...
Produce-to-Yield Vision: Multimodal identification of preparation-ready produce (e.g., 5 carrots, 2 kale leaves) and volumetric estimation.
...
Metabolic Guardrails: Real-time recipe analysis enforcing the 80/20 Rule (80% vegetables, 20% fruit) to prevent blood sugar spikes.
