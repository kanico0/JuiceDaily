      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleRow}>
            <Crown size={18} color="#FFD54F" />
            <Text style={styles.headerTitle}>Glow Library</Text>
          </View>
          <View style={{ width: 36 }} />
        </View>
        ...
        >
          <Text style={styles.subTitle}>Curated collections built for glow, consistency, and variety.</Text>
