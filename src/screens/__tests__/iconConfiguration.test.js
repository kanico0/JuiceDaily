...
describe('Issue 2 — Application Icon Configuration', () => {
  ...
  test('9. Version is 1.0.22/code 22', () => {
    expect(APP_JSON.expo.version).toBe('1.0.22')
    expect(APP_JSON.expo.android.versionCode).toBe(22)
  })

  test('9b. Runtime version policy remains appVersion (derives 1.0.22)', () => {
